      ...
      <div className="flex flex-wrap m-6">
        <div className="w-full md:w-1/2 lg:w-1/3 p-2">
          <button className="w-full h-20 bg-black text-white rounded-md font-semibold hover:bg-orange-500 flex items-center justify-left">
            ...
            <h1>Keep track of the films you've seen</h1>
          </button>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/3 p-2">
          <button className="w-full h-20 bg-black text-white rounded-md font-semibold hover:bg-orange-500 flex items-center justify-left">
            ...
            <h1 className="fa-solid fa-home">
              Show love to your favorite films
            </h1>
          </button>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/3 p-2">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 p-2">
          <button className="w-full h-20 bg-black text-white rounded-md font-semibold hover:bg-orange-500 flex items-center justify-left">
            ...
            <h1>Rate films based on a five-star scale</h1>
          </button>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/3 p-2">
          <button className="w-full h-20 bg-black text-white rounded-md font-semibold hover:bg-orange-500 flex items-center justify-left">
